...
/*
  ...
  // Debug UI 2 and 3 are handled here
  if (scene.nDebugUi2) {
    if (scene.mapbox_running) {
      nvgFontSize(s->vg, 40);
    } else {
    ...
    ui_print(s, ui_viz_rx, ui_viz_ry+480, "%.1f/%.1fm", scene.lateralPlan.dProb, scene.lateralPlan.laneWidth);
